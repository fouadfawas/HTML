document.addEventListener('DOMContentLoaded', () => {
    ...
    window.populatePowerOptions = function() {
        ...
        restartOption.className = 'settings-option';
        restartOption.innerHTML = `
            <div class="settings-option-title">Restart System</div>
            <div class="settings-option-desc">Restart your PlayStation 3 system</div>
        `;
        restartOption.addEventListener('click', () => {
            displayRestartSequence();
            PS3XMB.playSelectSound();
        });
        powerSection.appendChild(restartOption);
        
        // Add disc eject option
        const ejectDiscOption = document.createElement('div');
        ejectDiscOption.className = 'settings-option';
        ejectDiscOption.innerHTML = `
            <div class="settings-option-title">Eject Disc</div>
            <div class="settings-option-desc">Eject disc from drive</div>
        `;
        ejectDiscOption.addEventListener('click', () => {
            PS3XMB.showSystemNotification("No disc in drive", "info");
            PS3XMB.playSelectSound();
        });
        powerSection.appendChild(ejectDiscOption);
        ...
        // Helper function for restart sequence
        function displayRestartSequence() {
            // Create black screen overlay
            const overlay = document.createElement('div');
            overlay.className = 'game-launch-overlay';
            overlay.style.zIndex = '1000';
            ...
            messageElement.style.fontSize = '24px';
            messageElement.style.textAlign = 'center';
            messageElement.textContent = 'System restarting...';
            overlay.appendChild(messageElement);
            ...
            setTimeout(() => {
                ...
                // After 3 seconds, redirect to reload the page
                setTimeout(() => {
